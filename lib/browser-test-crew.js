...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!looksLikeRegisteredPhone) {
      ...
      const discovered = await discoverCrewPhone(page, baseUrl, null);
      if (discovered) {
        crewCreds = { email: discovered.phone, password: '' };
        console.log(`[browser-crew][${requestId}] Using discovered crew member: ${discovered.name} (${discovered.phone})`);
      } else {
